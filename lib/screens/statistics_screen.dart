...
class _StatisticsScreenState extends State<StatisticsScreen> {
  ...
  Future<void> _loadStats() async {
    ...
    setState(() {
      ...
      _alertesSortie = alertes
          .where((a) => a['type'] == 'Sortie du port')
          .length;
      _alertesSecurite = alertes
          .where((a) => a['type'] == 'Mode Sécurité')
          .length;
      _alertesIntrusion = alertes
          .where((a) => a['type'] == 'Intrusion détectée')
          .length;
      _isLoading = false;
    });
  }
